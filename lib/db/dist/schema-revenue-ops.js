...
export const outreachStrategies = pgTable('outreach_strategies', {
    ...
    channelOrder: jsonb('channel_order').$type().notNull().default([]),
    personalization: jsonb('personalization').$type().notNull().default({}),
    qualificationCriteria: jsonb('qualification_criteria').$type().notNull().default([]),
