...
1. Qwen3.8 Flash (`qwen3.8-flash`, via Alibaba Cloud Model Studio/DashScope) — primary, operator-funded, governed by its own capped/paced pool (ADR-017)
