...
const DRAWER = ['Sales Ops','Approvals','Agent Network','Log Stream','Campaigns','Leads','Suggestions','Portfolio','Control Room','Artifacts','Cron Registry','Health','Intelligence','CI/CD'];
...
const NAV_ID_TO_LABEL = {
  ...
  campaigns: 'Campaigns', salesops: 'Sales Ops', leads: 'Leads', suggestions: 'Suggestions',
